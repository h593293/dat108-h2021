...
public class Eksempel2_3og5 {
	...
	public static void printAll(List<Person> liste) {
		doConditionally(liste, p -> true, System.out::println);
	}
	
	//Med "hardkodet" betingelse
	public static void printLastNameStartsWithC(List<Person> liste) {
		doConditionally(liste, p -> p.getLastName().startsWith("C"), 
				System.out::println);
	}
	
	//Med generell betingelse
	public static void printConditionally(List<Person> liste, 
			Predicate<Person> predicate) {
		
		doConditionally(liste, predicate, System.out::println);
	}

	//Med generell oppførsel i tillegg til betingelse
...
//Se på i morgen tirsdag 14.09.2021?
//		Collections.sort(people, Comparator.comparing(Person::getLastName));
		...
		// Enda mer generell med doConditionally og Consumer og metodereferanse.
		doConditionally(people, p -> p.getFirstName().startsWith("C"), 
				System.out::println);
		System.out.println();
